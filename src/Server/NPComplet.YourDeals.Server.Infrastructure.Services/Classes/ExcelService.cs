...
namespace NPComplet.YourDeals.Server.Infrastructure.Services.Classes
{
    public class ExcelService : IExcelService
    {
        ...
        public ExcelService(IStringLocalizer<Translation> localizer)
        {
            ...
            , string sheetName = "Sheet1")
        {
            ...
            p.Workbook.Properties.Author = "NPComplet";
            ...
            foreach (var item in dataList)
            {
                ...
                foreach (var value in result) ws.Cells[rowIndex, colIndex++].Value = value;
            }
