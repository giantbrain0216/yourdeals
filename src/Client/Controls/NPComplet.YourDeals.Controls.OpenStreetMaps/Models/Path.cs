// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Path.cs" company="NPComplet">
//   Org
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
namespace NPComplet.YourDeals.Controls.OpenStreetMaps.Models
{
    ...
    public abstract class Path : InteractiveLayer
    {
        ...
        ///     <see href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/fill-rule">how the inside of a shape</see> is
        ///     determined.
        /// </summary>
        ...
        /// <summary>
        ///     A string that defines
        ///     <see href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/stroke-linecap">shape to be used at the end</see>
        ///     of the stroke.
        /// </summary>
        ...
        /// <summary>
        ///     A string that defines
        ///     <see href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/stroke-linejoin">
        ///         shape to be used at the
        ///         corners
        ///     </see>
        ///     of the stroke.
        /// </summary>
        ...
        ///     <see href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/stroke-dasharray">dash pattern</see>. Doesn't
        ...
        /// <summary>
        ///     A string that
        ///     <see href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/stroke-dashoffset">
        ///         defines the distance into
